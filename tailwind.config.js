...
//         }
//       }
//       return `.${e(`selected${separator}${className}`)}:where([data-selected])${pseudo}`;
//     });
//   });
// }
...
//       return `.${e(`expanded${separator}${className}`)}:where([aria-expanded="true"])`;
//     });
//   });
//   addVariant("not-expanded", ({ modifySelectors, separator }) => {
//     modifySelectors(({ className }) => {
//       return `.${e(`not-expanded${separator}${className}`)}:where([aria-expanded="false"])`;
//     });
//   });
// }
