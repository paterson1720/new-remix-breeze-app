        ...
        <div className="w-full mx-auto px-4 md:px-6 flex flex-col items-center space-y-8">
          <div className="text-center">
            ...
            <p className="text-gray-500 md:text-xl mt-12 dark:text-gray-400 max-w-3xl mx-auto">
              Effortlessly build and ship amazing web apps with Remix. We've already laid the
          ...
          <div className="flex flex-col text-center">
            ...
            <p className="text-sm text-orange-500 p-3 border border-muted-background rounded-md mt-2">
              npx @remix-breeze/cli g-crud -r posts -m "title:string content:text
              isPublished:boolean"
            </p>
          </div>
